...
export default function BlogListDisplay({usrData}) {
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(5);
  let rows = []
  let [blogData,setBlogdata] =useState()
  let [blogDataCount,setBlogdataCount] =useState()
  const {signup,currentUser,verifyEmail,delUserData} =useAuth()
          ...
          <TableContainer component={Paper} elevation={6} >
            ...
            <TableHead>
              <TableRow>
                ...
                <TableCell className='blogTableDate' align="center">User Email</TableCell>
                ...
                {(rowsPerPage > 0
                  ...
                  >
                    ...
                    {/* <IconButton aria-label="delete"  color="success" >
                      ...
                      <IconButton aria-label="delete"  color="success" >
                        <DeleteIcon onClick={()=>{handleDelete(row.email)}}/>
                      </IconButton>
                    </TableCell>
                  </TableRow>
                ))}
