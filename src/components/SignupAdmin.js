...
export default function Signup(){
    ...
    async  function handleSubmit(e){
        e.preventDefault()
        const encodedEmail = "ADM-" + window.btoa(emailRef.current.ref)
                   ...
                   <div className='signupFormContainer'>
                       <div>
                            ...
                            <form>
                                ...
                                <TextField type='password' margin='normal' label='Comfirm Password' color="primary" size='small' inputRef={passwordConfirmationRef} variant="filled" required></TextField>
