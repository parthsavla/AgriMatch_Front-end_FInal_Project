...
function handleEditorChange({ html, text }) {
  ...
  return (
    <>
    <TextField  fullWidth required type='text' size='small' inputRef={blogTitleRef} variant="outlined" label="Blog Tile" margin='normal' color='success'></TextField><br/>
    <MdEditor style={{ height: '70%' }} renderHTML={text => mdParser.render(text)} onChange={handleEditorChange} onImageUpload={onImageUpload}  />
